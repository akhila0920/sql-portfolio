...
This repository is actively maintained by Akhila Abbagani.

Akhila is a Data Analyst with 2+ years of professional experience, specializing in delivering analytics, business intelligence, and cloud-based data solutions across healthcare and insurance domains. She is proficient in SQL, Python, Power BI, Snowflake, Azure Databricks, Azure Data Factory, and Azure Synapse Analytics, with a focus on building scalable ETL pipelines, interactive dashboards, and analytical data models. Akhila excels at transforming complex data into actionable insights, improving reporting efficiency, and supporting data-driven business decisions through automation, data quality, and cross-functional collaboration.

**Key Skills:** Python, SQL, DAX, Pandas, NumPy, Scikit-learn
