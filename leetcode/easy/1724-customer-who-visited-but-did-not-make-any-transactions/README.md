...
### About the Developer
Akhila Abbagani is a Data Analyst with 3+ years of experience delivering analytics, business intelligence, and cloud-based data solutions across healthcare and insurance domains. She is experienced in SQL, Python, Power BI, Snowflake, and Azure data services for building scalable ETL pipelines and analytical data models. She specializes in transforming complex data into actionable insights and supporting data-driven business decisions through automation, data quality, and cross-functional collaboration.

**Technical Expertise:**
- Languages: SQL, Python
- Libraries: Pandas, NumPy, Scikit-learn, DAX
- Cloud & Data Tools: Azure Databricks, Azure Data Factory, Azure Synapse Analytics, Snowflake, Power BI