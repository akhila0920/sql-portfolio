...
I am a Data Analyst with over 3 years of experience in delivering analytics, business intelligence, and cloud-based data solutions. I specialize in SQL, Python, and Azure data tools to build scalable ETL pipelines and transform complex data into actionable insights. This repository serves as a collection of optimized SQL solutions and data modeling techniques designed to solve real-world analytical challenges.