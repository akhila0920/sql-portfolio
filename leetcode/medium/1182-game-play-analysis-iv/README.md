...
### About the Developer
Akhila is a Data Analyst with over 3 years of experience delivering analytics, business intelligence, and cloud-based data solutions. She specializes in SQL, Python, and Power BI, with extensive experience in building scalable ETL pipelines and transforming complex data into actionable business insights. Her technical background includes working with Snowflake, Azure Databricks, and Azure Synapse Analytics to support data-driven decision-making through automation and advanced data modeling.