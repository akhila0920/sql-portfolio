...
Please refer [insights.md](insights.md) for a detailed breakdown of findings.
...
If you have any questions, queries, or suggestions, please connect with me on [LinkedIn](https://www.linkedin.com/in/akhila-abbagani).

Please star the repository if this project inspired you or helped you in your work.


## About the Developer

Akhila Abbagani is a Data Analyst with over 3 years of experience delivering analytics, business intelligence, and cloud-based data solutions. She specializes in SQL, Python, and Azure data services to transform complex data into actionable insights.
