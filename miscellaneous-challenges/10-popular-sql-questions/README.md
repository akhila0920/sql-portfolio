...
Data Analyst with 3+ years of experience delivering analytics, business intelligence, and cloud-based data solutions across healthcare and insurance domains. Experienced in SQL, Python, Power BI, and Snowflake for building scalable ETL pipelines and analytical data models. This repository is maintained as a resource for mastering complex SQL queries and data transformation techniques.
