...
This project is maintained by Akhila Abbagani. The original SQL problems were sourced from the hirolau GitHub repository.

#### About the Developer
Akhila Abbagani is a Data Analyst with over 3 years of experience specializing in analytics, business intelligence, and cloud-based data solutions within the healthcare and insurance sectors.

- Key Skills: Python, SQL, DAX, Pandas, NumPy, Scikit-learn
- Expertise: Snowflake, Azure Databricks, Azure Data Factory, Power BI
