...
Akhila is a Data Analyst with over 3 years of experience specializing in SQL, Python, and cloud-based data solutions. This repository is maintained as a resource for practicing complex SQL queries and data modeling techniques. With a background in healthcare and insurance domains, Akhila focuses on transforming complex data into actionable business insights through automation and scalable ETL pipelines.
